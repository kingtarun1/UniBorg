...
async def _(event):
    ...
    packname = f"@kingtarun1 pack"
    packshortname = f"TarunMasterpiece{userid}"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"kingtarun1_AnimatedStickers"
        packshortname = f"kingtarun1_Animated"  # format: Uni_Borg_userid
